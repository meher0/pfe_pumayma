...
Route::get('/tester',                [ReunionController::class, 'tester'])->name('tester');
...
Route::get('invalide_route', function () {
...
Route::put('/acceptuser',             [UserController::class, 'AcceptUser'])->name('acceptuser');
