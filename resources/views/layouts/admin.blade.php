            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">تفاصيل الحسابات</h6>

                        <a class="collapse-item" href="NewUser">الحسابات الجديدة</a>
                        <a class="collapse-item" href="{{route('ListUser')}}">جميع الحسابات</a>
                    </div>
                </div>
            </li>
   <!-- Divider -->
