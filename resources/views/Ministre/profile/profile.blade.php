...
@section('content')
    <style>
        ...
        input.Btn{
            ...
            color: #fff;
            cursor: pointer;
            background-color: rgba(149, 57, 203, 0.65);
            box-shadow: inset 0 0 0 2px #865adb,
            0 2px 0 0 rgba(112, 21, 187, 0.5);
            transition: 0.5s ease;
        }
        input.Btn:hover{
            background-color: rgb(149, 57, 203);
        }
        ...
        .btn-profile{
            opacity: 1;
            color: #fff;
            background-color: rgb(167, 39, 210);
            top: 45%;
            left: 25%;
            padding: 10px 15px;
            border-radius: 3px;
    ...
    @if (session('alert_green'))
        <script>
            ...
            toastr.success("{{ session('alert_green') }}", {timeOut: 5000})
        </script>
    @endif
    ...
    <div class="wrapper">
        <div class="profile">
            <div class="content">
                <h1>Edit Profile</h1>
                <form action="{{route('handleMinistereUpdatePictureProfile')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <!-- Photo -->
                    <fieldset>
                        <div class="grid-35">
                        ...
                        <div class="grid-65">
                            <span class="photo" title="Upload your Avatar!">
                                ...
                                <img src="../../uploads/profile/{{Auth::user()->picture}}"  style="width: 80px;height: 80px;" >

                            </span>
                            <input type="file" name="picture" class="btn" required />
                            <button class="btn-profile">change picture</button>

                        </div>
                    </fieldset>
                </form>
                <form action="{{route('handleMinistereUpdateProfile')}}" method="post" >
                    @csrf
                    <fieldset>
                        <div class="grid-35">
                        ...
                        <div class="grid-65">
                            <input type="text" id="fname" tabindex="1" name="name" value="{{Auth::user()->name}}" required />
                        </div>
                    </fieldset>
                    <fieldset>
                        <div class="grid-35">
                        ...
                        <div class="grid-65">
                            <input type="text" id="lname" tabindex="2"  name="lastname" value="{{Auth::user()->lastname}}"  />
                        </div>
                    </fieldset>
                    <!-- Email -->
                    <fieldset>
                        ...
                        <div class="grid-65">
                            <input type="email" id="email" tabindex="6"  name="email" value="{{Auth::user()->email}}" required/>
                        </div>
                    </fieldset>
